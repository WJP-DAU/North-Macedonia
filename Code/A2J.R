...
openxlsx::write.xlsx(list_of_datasets, 
           file = paste0(path2SP, 
                         "/6. Country Reports/North-Macedonia/Outputs/A2J_tables.xlsx"))
...
ggsave(plot = figure_A2J_a, 
       filename = paste0(path2SP, 
                         "/6. Country Reports/North-Macedonia/Outputs/imgChartA2J/A2Ja.svg"), 
       width = 131.7974, 
       height = 65.02006,
       units  = "mm",
       dpi    = 72,
...
ggsave(plot = figure_A2J_b, 
       filename = paste0(path2SP, 
                         "/6. Country Reports/North-Macedonia/Outputs/imgChartA2J/A2Jb.svg"), 
       width = 131.7974, 
       height = 65.02006,
       units  = "mm",
       dpi    = 72,
