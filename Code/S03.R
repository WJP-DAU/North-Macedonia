...
figure_POP.fn <- function(nchart = 17, data = master_data.df) {
  ...
  # Saving data points
  data_POP = bind_rows(panelA, panelB, panelC, panelD, panelE, panelF, panelG) %>% ungroup()
  return(data_POP)
